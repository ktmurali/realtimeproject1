...
public class AppConfig implements WebMvcConfigurer{
	...
	{   
		...
		s.setAnnotatedClasses(ShipmentType.class,UomDataType.class,OrderDataType.class,WhUserDataType.class,UploadFileType.class); 
		//s.setAnnotatedPackages("com.nt.model");
  ...
  return p; 
	...
	public CommonsMultipartResolver uploadFile()
	{
		CommonsMultipartResolver cmf=new CommonsMultipartResolver();
		return cmf;	
